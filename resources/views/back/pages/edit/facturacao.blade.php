...
@section('content')
    <br><br>
    <br><br>
    <form action="{{route('autor.facturacao.update', ['id'=>Request('id')]) }}" method="post" id="XeditFactura">   
        @CSRF
        <div class="mb-3">
            <div class="row">
                            ...
                            <div class="form-selectgroup-boxes row mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @foreach(\App\Models\empresa::all() as $empresa)
                                        <option @if(old('cliente') == $data->id) {{"selected = 'selected'"}} @endif  value="{{$empresa->id}}" {{$data->empresa_id == $empresa->id ? 'selected' : ''}}>{{$empresa->empresa}}</option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="largura_banda_contratada" value="{{old('largura_banda_contratada', $data->largura_banda_contratada)}}" id="largura_banda_contratada" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name ="preco_unitario" value="{{old('preco_unitario', $data->largura_banda_contratada)}}" id="preco_unitario" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="banda_facturada" value="{{old('banda_facturada', $data->banda_facturada)}}" id="banda_facturada" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="valor_facturado" value="{{old('valor_facturado', $data->valor_facturado)}}" id="valor_facturado" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" id="aumento_banda" value="{{old('aumento_banda', $data->aumento_banda)}}" name="aumento_banda" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" name ="data_aumento_banda" value="{{old('data_aumento_banda', $data->data_aumento_banda)}}" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name ="diminuicao_banda" value="{{old('diminuicao_banda', $data->diminuicao_banda)}}" id="diminuicao_banda" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" name ="data_diminuicao_banda" value="{{old('data_diminuicao_banda', $data->data_diminuicao_banda)}}" id="data_diminuicao_banda" class="form-control">
                                    ...
                                    <input type="text" name ="comprovativo" value="{{old('comprovativo', $data->comprovativo)}}" class="form-control">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" name ="data_facturacao" value="{{old('data_facturacao', $data->data_facturacao)}}" class="form-control">
                                    ...
                                    <input type="text" name ="valor_pago" name="valor_pago" value="{{old('valor_pago', $data->valor_pago)}}" id="valor_pago" class="form-control">
                                ...
                                <hr>Notas<hr>
                                    ...
                                    <input type="text" name ="debito" id="debito" value="{{old('debito', $data->debito)}}" class="form-control">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name ="credito" id="credito" value="{{old('credito', $data->credito)}}" class="form-control">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="text" name ="divida" id="divida" value="{{old('divida', $data->divida)}}" class="form-control">
