            ...
            <div class="row">
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Ministerios</div>
                    <div class="display-5 my-3">$0</div>
                    <ul class="list-unstyled lh-lg">
                      <li><strong>3</strong> Clientes</li>
                      <li>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  ...
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Institutos Publicos</div>
                    <div class="display-5 my-3">$49</div>
                    <ul class="list-unstyled lh-lg">
                      <li><strong>10</strong> Clientes</li>
                      <li>
                        <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-success" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M5 12l5 5l10 -10"></path></svg>
                        Sharing Tools
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Institutos Privados</div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Instituicoes de Ensinos</div>
                    <div class="display-5 my-3">$139</div>
                    <ul class="list-unstyled lh-lg">
                      <li><strong>Unlimited</strong> Clientes</li>
                      <li>
                        <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1 text-success" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M5 12l5 5l10 -10"></path></svg>
                        Sharing Tools
